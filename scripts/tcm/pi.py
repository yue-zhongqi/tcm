...
config_file = "configs/ic/pi_n5.txt"
...
args = ["--gpu_ids", gpu, "--s_dset", s_set, "--s_name", s_name, "--t_dset", t_set, "--t_name", t_name, "--dataset_name", dataset_name, "--name", "dda1blpr_%s" % (exp_name), "--resnet_name", "ResNet50", "--cdt_exp_name", cyclegan, "--test_interval", "100", "--train_batch_size", batch_size, "--test_batch_size", batch_size, "--align_logits", "--gvbd_weight", "0.0", "--gvbg_weight", "0.0", "--num_classes", num_classes, "--pretrain_iteration", "300", "--backward_linear_loss", "--n_iterations", "3000", "--alpha", alpha]
args_str = " ".join(args)
