...
class GeneratorPanel(nn.Module):
    def __init__(self, architecture, input_nc, output_nc, ngf, norm, use_dropout, n_experts, init_type, init_gain, gpu_ids):
...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[], n_experts=1):
    """Create a generator
